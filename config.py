...
OWNER_ID = int(getenv("OWNER_ID", 7803657513))
OWNER_USERNAME = getenv("OWNER_USERNAME", "WTF_NoHope")
LOGGER_ID = int(getenv("LOGGER_ID", None))

# ===============================================

BOT_USERNAME = getenv("BOT_USERNAME", "BlitzBeatsBot")
BOT_NAME = getenv("BOT_NAME", "Blitz Beats")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/vipchor3215/Amitamusic")
